...
export const createCaller = (
  ...
  ({
    ...
    res?: FastifyReply | object; // Make sure res can be of type FastifyReply or any object
  }) => {
...
export const createAuthenticatedCaller = ({ userId }: { userId: number }) => {
  ...
  return createCaller({
    ...
    res: {
      setCookie: () => {}, // Include necessary properties like setCookie and clearCookie
      clearCookie: () => {}, // Add any other required properties
    },
  });
};
